/* 検査の土台 ― SemiLab の物理と数値の読み取り（../SemiLab/src）と、このラボの src を vm で読む。
 * 数え方・比べ方は SemiLab の tests/check.js、DOM の模型は tests/dom.js を共用する */
'use strict';
const fs = require('fs');
...
const OWN = ['rng', 'pixel', 'camera', 'ptc', 'quest', 'answer', 'store'];
