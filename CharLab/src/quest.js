  ...
  var LIST = [
    ...
    },
    {
      ...
      why: 'n が決まれば、直線を V=0 まで延ばした切片が Is ― **Is = I / e^(V/nVt)**。'
         ...
         + 'Is は接合面積と温度に敏感（拡散電流なので nᵢ² に比例 ― 室温で約 4.3 K ごとに倍（300 K での微分では 4.2 K）。第4章 teg で確かめられる）― データシートの Is に必ず温度が添えてある理由。',
    ...
    },
    {
      ...
      hint: 'Wdmax ≈ 62 nm。Na = 4εs·φF/(q·Wdmax²)、εs=1.036×10⁻¹² F/cm、q=1.6×10⁻¹⁹。',
      check: function (ev, d) {
    ...
    /* ===== 第4章 ===== */
    {
      ...
      why: '拡散電流の Is は ni² に比例し、ni² ∝ T³·exp(−Eg/kT)。だから **ln(Is/T³) を 1/T に対して引くと直線で、傾きが −Eg/k**。'
         ...
         + 'Is が室温で約 4.3 K ごとに倍になる（300 K での微分では 4.2 K。第2部の「約 4〜5 ℃」の中身）のも、この指数の急さ。',
    ...
    },
    {
      ...
      hint: 'V = 0 と −1 V の2点で。N = 2/(q·εs·|Δ(1/C²)/ΔV|)、εs = 1.036×10⁻¹² F/cm。C は nF/cm² を F/cm² に直す。',
      check: function (ev, d) {
