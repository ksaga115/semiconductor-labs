/* 保存と読み込み（SemiLab / QALab と同じ作法: 壊れた保存は退避してから空で始める） */
(function (global) {
  'use strict';
  var CL = global.CL || (global.CL = {});

  var KEY = 'CharLab.v1';
  var BACKUP = 'CharLab.broken';

  function blank() {
    return {
      design: CL.char.defaults(),
      cleared: {},
      quest: null
    };
  }
  ...
  CL.store = { KEY: KEY, BACKUP: BACKUP, blank: blank, save: save, load: load, clear: clear, looksSane: looksSane };
