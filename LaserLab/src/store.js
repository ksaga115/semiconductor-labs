...
(function (global) {
  ...
  var KEY = 'LaserLab.v1';
  var BACKUP = 'LaserLab.broken';

  function blank() {
    return { design: LS.laser.defaults(), cleared: {}, quest: null };
  }

  function looksSane(s) {
    return !!(s && typeof s === 'object' && s.design && typeof s.design === 'object'
      && typeof s.design.tk === 'number');
  }
  ...
  LS.store = { KEY: KEY, BACKUP: BACKUP, blank: blank, save: save, load: load, clear: clear, looksSane: looksSane };
