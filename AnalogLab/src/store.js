...
(function (global) {
  ...
  var KEY = 'AnalogLab.v1';
  var BACKUP = 'AnalogLab.broken';

  function blank() {
    return { design: AN.analog.defaults(), cleared: {}, quest: null };
  }

  function looksSane(s) {
    return !!(s && typeof s === 'object' && s.design && typeof s.design === 'object'
      && typeof s.design.wl === 'number');
  }
  ...
  AN.store = { KEY: KEY, BACKUP: BACKUP, blank: blank, save: save, load: load, clear: clear, looksSane: looksSane };
