...
(function (global) {
  ...
  var KEY = 'QALab.v1';
  var BACKUP = 'QALab.broken';

  function blank() {
    return { design: QA.qa.defaults(), cleared: {}, quest: null };
  }

  function looksSane(s) {
    return !!(s && typeof s === 'object' && s.design && typeof s.design === 'object'
      && typeof s.design.fitr === 'number');
  }
  ...
  QA.store = { KEY: KEY, BACKUP: BACKUP, blank: blank, save: save, load: load, clear: clear, looksSane: looksSane };
